	...
	public PanelEnterGame(MainPanelStartGame mainPanelStartGame) {
		...
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				changeState(new PanelCreate(PanelEnterGame.this.mainPanelStartGame, PanelEnterGame.this));
			}
		});
		add(createButton);
		...
		loadButton.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				changeState(new PanelLoad(PanelEnterGame.this.mainPanelStartGame, PanelEnterGame.this));
			}
		});
		add(loadButton);
