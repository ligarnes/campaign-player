...
public class PanelLoad extends JPanel {
	...
	private final void initGui() {
		...
		savedGameList.setSelectionMode(ListSelectionModel.SINGLE_INTERVAL_SELECTION);
	...
	public void load(String campaign){
		...
		PanelLoad.this.mainPanelStartGame.changeState(new PanelChoosePlayer(mainPanelStartGame, this));
