...
public class TriggerEditor extends PanelMapElementEditor<TriggerBean>{
	...
	private ArrayList<Integer> selectedEffects;
	...
	public TriggerEditor(TriggerBean mapElement) throws ClassNotFoundException {
		...
		ArrayList<Class<?>> classList=eGenerator.getEffectClasses(EffectChoiceListGenerator.path); 
		ArrayList<String> effectNameList=eGenerator.getEffectName(EffectChoiceListGenerator.path);
