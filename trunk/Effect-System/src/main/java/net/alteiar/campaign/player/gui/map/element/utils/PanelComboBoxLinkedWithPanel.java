...
public class PanelComboBoxLinkedWithPanel extends PanelLinkedComboBox{
	...
	public PanelComboBoxLinkedWithPanel(ArrayList<ArrayList<String[]>> list,ArrayList<ArrayList<JPanel>> panelList) {
		super(list);
		modelList=panelList;
	  ...
	  public ArrayList<ArrayList<JPanel>> getModelList(){
	   ...
	   public  void getModelListChoices(int indexPanel,ArrayList<JPanel> modelListChoices){
		  modelList.set(indexPanel, modelListChoices);
	   }
	   
	   public void getModelListChoice(int indexPanel,int indexChoice,JPanel choice){
	  ...
	  public void getCurrentPan(int indexPanel,Integer pan)
	  {
	   ...
	   {
		   modelList.get(indexPanel).get(currentPans.get(indexPanel)).setVisible(false);
