...
public class PanelMonitorStun extends JPanel implements PropertyChangeListener {
	private static final long serialVersionUID = 1L;

	private int rowCount;
	private ShadowrunCharacter character;

	public PanelMonitorStun() {
	...
	public void setCharacter(ShadowrunCharacter character) {
		...
		int total = this.character.getStunPoint();
	...
	public void refresh() {
		...
		int totalDamage = this.character.getStunDamage();
		int totalPhysical = this.character.getStunPoint();
