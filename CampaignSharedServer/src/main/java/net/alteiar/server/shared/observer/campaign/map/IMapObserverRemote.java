 ...
 * 
 */
public interface IMapObserverRemote extends Remote {
	void mapElementAdded(IMapElementObservableRemote element) throws RemoteException;

	void mapElementRemoved(IMapElementObservableRemote element) throws RemoteException;
