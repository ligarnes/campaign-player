 ...
 * 
 */
public interface IFilterRemote extends IGUIDRemote {
	void addFilterListener(IMapFilterObserverRemote listener)
			throws RemoteException;

	void removeListener(IMapFilterObserverRemote listener)
			throws RemoteException;
