...
public class PanelLinkedComboBox extends JPanel {
	...
	public PanelLinkedComboBox(ArrayList<ArrayList<String[]>> list) {
		...
		for (int i = 0; i < list.size(); i++) {
			DefaultComboBoxModel[] temp = new DefaultComboBoxModel[list.get(i)
					.size()];
	...
	public DefaultComboBoxModel getComboModelChoice(int indexComboBox,
			int indexComboModel) {
	...
	public void getComboModelChoices(int indexCombobox,
			DefaultComboBoxModel[] comboModelChoices) {
		comboModels.set(indexCombobox, comboModelChoices);
	}

	public void getComboModelChoice(int indexCombobox, int indexComboModel,
			DefaultComboBoxModel comboModelChoice) {
	...
	public void setModelToComboBox(int indexComboBox, int indexComboModel) {
		comboBoxes[indexComboBox]
				.setModel(comboModels.get(indexComboBox)[indexComboModel]);
	}
}
